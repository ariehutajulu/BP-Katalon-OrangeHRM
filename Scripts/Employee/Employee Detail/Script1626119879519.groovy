...
response = WS.sendRequest(findTestObject('API/Employee/Employee Detail', [('baseurl') : GlobalVariable.baseURL,('id') : GlobalVariable.idP, ('tokenaut') : GlobalVariable.tokenaut]))
