...
responseBaru = WS.sendRequest(findTestObject('API/Employee/Update Employee Detail', [('tokenaut') : GlobalVariable.tokenaut, ('baseurl') : GlobalVariable.baseURL
            , ('id') : GlobalVariable.idP, ('firstname') : GlobalVariable.firstName, ('middlename') : GlobalVariable.middleName
...
WS.verifyElementPropertyValue(responseBaru, 'success', 'Successfully Updated')
