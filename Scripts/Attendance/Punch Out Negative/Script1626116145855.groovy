...
'Already punch out'
responseBaru = WS.sendRequest(findTestObject('API/Attendance/Punch Out', [('baseurl') : GlobalVariable.baseURL,('tokenaut') : GlobalVariable.tokenaut, ('id') : GlobalVariable.idP, ('timezone') : GlobalVariable.timezone, ('note') : GlobalVariable.notePO
	, ('datetime') : GlobalVariable.datetime]))
WS.delay(2)

responseBaru = WS.sendRequest(findTestObject('API/Attendance/Punch Out', [('baseurl') : GlobalVariable.baseURL,('tokenaut') : GlobalVariable.tokenaut, ('id') : GlobalVariable.idP
			, ('timezone') : GlobalVariable.timezone, ('note') : GlobalVariable.notePO, ('datetime') : GlobalVariable.datetime]))

WS.verifyResponseStatusCode(responseBaru, 202)
WS.verifyElementPropertyValue(responseBaru, 'error.text', 'Cannot Proceed Punch Out Employee Already Punched Out')


'wrong datetime format'
responseBaru = WS.sendRequest(findTestObject('API/Attendance/Punch Out', [('baseurl') : GlobalVariable.baseURL,('tokenaut') : GlobalVariable.tokenaut, ('id') : GlobalVariable.idP
			, ('timezone') : GlobalVariable.timezone, ('note') : GlobalVariable.notePO, ('datetime') : '2020']))
